...
const activeAccount_controller_1 = tslib_1.__importDefault(require("./activeAccount.controller"));
...
router
    ...
    try {
        ...
        res.json(Object.assign(Object.assign({}, data), { message: yield (0, activeAccount_controller_1.default)(data) }));
    }
    catch (err) {
