...
import { useCreateTaskMutation } from "@/redux/queries/task";
...
import { useUpdateTaskMutation } from "@/redux/queries/task.query";
...
export default function CreateTaskForm({
  ...
  async function onSubmit(values: taskFormProps) {
    const parsedValue = { ...values, serial: serial };
    const { data } = await update(parsedValue);
    console.log(data);
  }
